...
\begin{Figure}
 ...
 \captionof{figure}{Bill Brose's House}
\end{Figure}
...
\textbf{OLD BUSINESS}
\begin{itemize}
\item    John Zolko reported
\item	More work to be done by climbers on church roof in East Liberty.
\item	Nice coverage in Post Gazette. 
\item    Ron Edwards reported
\item	New Logo project is still open - submissions will be reviewed by BOG
\end{itemize}
 
\textbf{NEW BUSINESS}
\begin{itemize}
\item    Tom Prigg proposed we take older documents and produce a digital archive.
\item    	Probably will require professional archiving services
\item    	Must  identify tasks and get cost quotations
\item	General approval subject to cost.  
\end{itemize}
